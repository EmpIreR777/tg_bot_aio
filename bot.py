...
import httpx
from magic_filter import F as FFF
...
async def send_random_value(callback: types.CallbackQuery):
    ...
    await callback.answer(text='Спасибо что тыкнул',
                          show_alert=True)
...
async def withour_puree(message: types.Message):
    await message.reply('Так не вкусно!', reply_markup=types.ReplyKeyboardRemove())
